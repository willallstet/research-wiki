...
## [2026-07-08] lint | fixed 1 broken link (index.md format-legend placeholder parsed as a link); staleness clean (8 portfolio pages pinned at HEAD af63cc3, no drift); links/orphans clean; taxonomy matches page dirs
